import UnorderList from "./recipes_list";
import { OrderList } from "./recipes_list";
// import"./recipesdata"
import "./recipes.css"
const Items={
  "recipes": [
        ...
        {Items["recipes"].map((Items, id) => (
          <div className="card" key={id}>
            ...
            <div className="info">
              <h1>{Items.name}</h1>
              <p>ID:{Items.id}</p>
              <p>Ingredients: <OrderList array={Items["ingredients"]}/></p>
              <p>Instructions:<UnorderList array={Items["instructions"]}/></p>
               <p>PrepTimeMinutes:{Items.prepTimeMinutes}</p><p>CookTimeMinutes:{Items.cookTimeMinutes}</p>
               <p>Servings:{Items.servings}</p> <p>Cuisine:{Items.cuisine}</p>
               <p>Difficulty:{Items.difficulty}</p><p>CaloriesPerServing:{Items.caloriesPerServing}</p>
               <p>Tags:{Items.tags}</p><p>UserId:{Items.userId}</p>
               <p>Rating:{Items.rating}</p><p>ReviewCount:{Items.reviewCount} </p>
               <p>MealType:{Items.mealType}</p>
            </div>
          </div>
        ))}
      </div>
